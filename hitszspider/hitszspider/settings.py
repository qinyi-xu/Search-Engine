...
BOT_NAME = 'hitszspider'

SPIDER_MODULES = ['hitszspider.spiders']
NEWSPIDER_MODULE = 'hitszspider.spiders'
...
ITEM_PIPELINES = {
   ...
   'hitszspider.pipelines.MongoDBPipeline' : 500,
}
MONGODB_HOST = "localhost"
MONGODB_PORT = 27017
MONGODB_DBNAME = "hitsz_news_db"
